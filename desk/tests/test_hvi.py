...
def test_hvi_com_comprimento_no_minimo_comercial_e_valido():
    hvi = HVIParametros(micronaire=4.2, comprimento=1.11, resistencia=29.0, uniformidade=82.0)
...
def test_hvi_com_comprimento_abaixo_do_minimo_comercial_levanta_erro():
    with pytest.raises(ComprimentoAbaixoDoMinimo):
        HVIParametros(micronaire=4.2, comprimento=1.05, resistencia=29.0, uniformidade=82.0)


def test_hvi_com_resistencia_no_minimo_comercial_e_valida():
    hvi = HVIParametros(micronaire=4.2, comprimento=1.16, resistencia=28.0, uniformidade=82.0)
